      ...
      child: Column(
        ...
        children: [
          ClipRRect(
              ...
              child: Image.network("https://firebasestorage.googleapis.com/v0/b/musicapp-73ddc.appspot.com/o/cover%2FImagine%20Dragons%20-%20Radioactive%202.jpg?alt=media&token=e8056626-a963-44f2-b097-11f0bc09c331")),
          Padding(
                ...
                child: Column(
                  children: [
                    FlatButton(
                      onPressed: (){
                        Navigator.of(context).pop();
                        Navigator.of(context).pushNamed('/imagine');
                      },
                      child: Text("Radioactive",
